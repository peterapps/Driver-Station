...
def getButtons():
    return {
    "btn": {
        "btn_3": {"x": width-77, "y": 304, "title": "Btn 3", "anchor": CENTER},
        "btn_2": {"x": width-136, "y": 240, "title": "Btn 2", "anchor": CENTER},
        "btn_1": {"x": width-194, "y": 304, "title": "Btn 1", "anchor": CENTER},
        "btn_4": {"x": width-136, "y": 365, "title": "Btn 4", "anchor": CENTER},
        "btn_5": {"x": width-517, "y":  401, "title": "Btn 5", "anchor": CENTER} #, "ty": 445}
    },
    "clicker": {
        "clicker_4": {"x": width-330, "y": clickery, "title": "Clicky 4", "anchor": CENTER},
        "clicker_3": {"x": width-458, "y": clickery, "title": "Clicky 3", "anchor": CENTER},
        "clicker_2": {"x": width-586, "y": clickery, "title": "Clicky 2", "anchor": CENTER},
        "clicker_1": {"x": width-714, "y": clickery, "title": "Clicky 1", "anchor": CENTER}
    },
    "slider": {
        "slider_2": {"x": width-594, "y": slidery, "title": "Slider 2", "anchor": N, "ty": 180},
        "slider_1": {"x": width-688, "y": slidery, "title": "Slider 1", "anchor": N, "ty": 180}
    }
    }
buttons = getButtons()
...
backupBtn = {"img": btnImg, "x": width-80, "y": 40, "width": btnW, "height": btnH, "title": "Backup", "tag": "backupBtn"}
resetBtn = {"img": btnImg, "x": width-80, "y": 100, "width": btnW, "height": btnH, "title": "Reset", "tag": "resetBtn"}
checkBtn = {"img": btnImg, "x": width-80, "y": 160, "width": btnW, "height": btnH, "title": "Checklist", "tag": "checkBtn"}
...
def callback(event):
    ...
    #State 0: Normal state
        ...
        ctx.create_text(backupBtn["x"]-btnW/2, backupBtn["y"], text="Click on a button to replace",
                        anchor=E, fill="white", tag="backupBtnT")
        state = 1
